...
import me from "../../assets/images/willy_1x1.webp";
...
export default function Projects() {
  ...
  return (
    <>
      <Head>
        <title>{`Willy Prado | ${t("projects.title")}`}</title>
      </Head>
      ...
      >
        <div className="grid grid-cols-3 gap-2 md:grid-cols-4 md:gap-4 my-5 container mx-auto xl:px-20">
          <div className="col-span-3 md:col-span-4 aspect-2/1 md:aspect-auto flex justify-between items-center bg-[#3a05319c] dark:bg-[#ff72c056] rounded-3xl overflow-hidden">
          ...
          <div className="col-span-3 md:col-span-4 bg-[#3a05319c] dark:bg-[#ff72c056] h-16 rounded-3xl overflow-y-hidden relative">
