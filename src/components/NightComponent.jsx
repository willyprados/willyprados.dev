...
export default function NightComponent({
  ...
  if (isLoading) {
    // Un estado de carga simple para evitar errores visuales
    return <div className="bg-[#001324] w-full h-full flex items-center justify-center text-white">Loading...</div>;
  }
