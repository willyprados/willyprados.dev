...
export default function LanguagueCard() {
  ...
  return (
    <div
      ...
      className="flex flex-col justify-center items-center bg-[#3a052c9c] dark:bg-[#ff72bb56] rounded-3xl relative overflow-hidden col-span-1 aspect-square shadow-sm cursor-pointer hover:scale-[103%] transition duration-300 ease-in-out"
    >
