...
export default function BirthdayCard() {
  ...
  const getAge = () => {
    let age = moment().diff(moment([1994, 3, 23]), "years");
    return age;
  };
  ...
  const getBirthday = () => {
    ...
    if (month > 3 && day > 23) year += 1;

    let birthday = moment([year, 3, 23]);
    return birthday.diff(moment(), "days");
  };

  return (
    <div className="text-white rounded-3xl flex relative overflow-hidden aspect-square shadow-sm bg-[#ff48c5d3] dark:bg-[#ff48c556] p-4 justify-center items-center">
      <div className="">
